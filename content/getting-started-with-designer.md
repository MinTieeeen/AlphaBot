...
![opening designer app](/hc/article_attachments/42087941829011)

Next, hit **Designer**. This will open the Designer app.

![designer app](/hc/article_attachments/42087941835667)
...
![designer app overview image](/hc/article_attachments/42087941838995)
...
![designer viewer](/hc/article_attachments/42088011998739)
...
![designer name entry](/hc/article_attachments/42087941844243)
...
![](/hc/article_attachments/42282228321299)
...
![](/hc/article_attachments/42282228324115)
...
![select folder tab](/hc/article_attachments/42087941861011)
...
![empty design saved notification](/hc/article_attachments/42087941863315)
...
![unsaved changes notification](/hc/article_attachments/42087941868819)

**New Design -** Exits the current design and creates a new one. The **New Design** panel will appear on the left sidebar:

![new design left navbar](/hc/article_attachments/42087941873043)
...
![download options](/hc/article_attachments/42087941875987)

### Image

The **Image** option allows you to upload images into your design.

![image button location](/hc/article_attachments/42087941879187)

When clicked, it will give you two options: **My Device** , and **Image Assets**.

![image location options](/hc/article_attachments/42087941883155)
...
![shapes button location](/hc/article_attachments/42087941895315)

Choosing **Shapes** from the Top Menu will open the **Elements** tab on the Side Menu:

![shapes and elements left navbar](/hc/article_attachments/42087941898515)
...
![shape added to design](/hc/article_attachments/42088011940115)

Shapes are reactive and can be resized or rotated at will:

![firefox_9GYjGYVRec.gif](/hc/article_attachments/42278925006227)
...
![shape click changed top menu](/hc/article_attachments/42087941901715)

Finally, the Shape or Element itself has a full set of options:

![shape options](/hc/article_attachments/42087941902739)
...
![background button location](/hc/article_attachments/42087941903763)

Clicking it will open up the **Canvas Background** area on the Side Menu:

![canvas background left navbar](/hc/article_attachments/42087941906067)

Selecting any of the colors will apply it to your design:

![background demonstration](/hc/article_attachments/42088011946387)
...
![hexadecimal color option](/hc/article_attachments/42087941910419)

### Frame

Selecting the **Frame** option will allow you to add a frame around your design![frame button location](/hc/article_attachments/42088011950355)

Clicking it will open up the **Frame** area on the Side Menu:

![frame left navbar](/hc/article_attachments/42087941916947)

Clicking one of these frames will apply it to your design:

![frame demonstration](/hc/article_attachments/42088011956371)

### Filter

Selecting the **Filter** option will allow you to apply one of several filters to the design.

**![filter button location](/hc/article_attachments/42088011958163)**

Clicking it will open the**Frame** panel on the Side Menu:

![filter left navbar](/hc/article_attachments/42088011959571)

These filters can be applied to the entire design, or to individual image or background elements like so:

![filter demonstration](/hc/article_attachments/42088011961491)
...
![draw button location](/hc/article_attachments/42087941931411)

Clicking it opens up the **Draw** panel on the Side Menu:

![draw option left navbar](/hc/article_attachments/42088011974803)
...
![designer draw demonstration](/hc/article_attachments/42087941936403)

These drawn elements can be selected and edited just like any other element of the design.

![drawn elements move demonstation](/hc/article_attachments/42087941938067)

### Resize

Selecting the **Resize** option allows you to change the size of the design.

![resize button location](/hc/article_attachments/42088011986195)

Clicking it will open the **Resize** area on the Side Menu:

![resize left navbar](/hc/article_attachments/42087941942675)
...
![animate button location](/hc/article_attachments/42088011992339)

Clicking it will open the **Animate** area on the Side Menu:

![animate left navbar](/hc/article_attachments/42087941947283)

In order to add animations, you’ll need to select an element of your design. Then, hit **Add** :

![page animations example](/hc/article_attachments/42087941949587)
...
![designer preview](/hc/article_attachments/42095571715859)Please note that this **Preview** may be slightly different than what will actually appear depending on the hardware you are using to run OptiSigns and various other factors. 

#### Push to Screens

![push to screens](/hc/article_attachments/42088012000531)
...
![close button warning](/hc/article_attachments/42087941956627)

This gives you the option to Keep Editing, Discard Changes, or Save Changes and close.

### Undo/Redo

![](/hc/article_attachments/42282228332691)
...
![zoom button location](/hc/article_attachments/42087941957523)

Can be adjusted with the ‘+’ or ‘-’ buttons.

![zoom demonstration](/hc/article_attachments/42087941959059)

### Layers

The **Layers** button allows you to change the layering of the elements on your design.

![layer button location](/hc/article_attachments/42088012017939)

When clicked, it will open the **Position** window on the Side Menu, under the **Layers** tab.

![layer tab left navbar](/hc/article_attachments/42087941967123)
...
![layer demonstration](/hc/article_attachments/42088107390611)
...
![history button location](/hc/article_attachments/42087941970195)

Clicking it will open the **Position** window on the Side Menu under the **History** tab:

![history tab left navbar](/hc/article_attachments/42087941973267)
...
![history tab demonstration](/hc/article_attachments/42088012037523)
...
![hand tool location](/hc/article_attachments/42087941983507)

When selected, the hand tool icon will turn green and your cursor will change to a hand. The canvas can then be moved:

![hand tool demonstration](/hc/article_attachments/42088012046995)
...
![left navbar designer](/hc/article_attachments/42095580131219)
...
![designer 1.0 option](/hc/article_attachments/42087941992211)
...
Related to
  ...
  * [ designer ](/hc/en-us/search?content_tags=01JYSAQ3X6QZV9XK7SG8ATNRDJ&utf8=%E2%9C%93 "Search results")
