...
![OptiSigns Teams Rooms — the two ways to connect: Signage URL \(recommended\) and Service Principal](/hc/article_attachments/54863307377299)
...
![The New Signage URL dialog — name the URL, then click Next](/hc/article_attachments/54863298194195)
...
![The Assign content dialog — pick a Content Type, choose the item, then Save](/hc/article_attachments/54863350797331)
...
![The paste-instructions dialog — copy the URL, then click Open Teams Admin Portal](/hc/article_attachments/54863314048403)
...
![Register an application — name the app, choose Single tenant, leave Redirect URI blank, then Register](/hc/article_attachments/54863314201107)
...
![The app Overview page with Application \(client\) ID and Directory \(tenant\) ID highlighted](/hc/article_attachments/54863351234835)
...
![The Request API permissions panel with Microsoft Graph selected](/hc/article_attachments/54863351394707)

### Step 4 — Application permissions, then TeamworkDevice.Read.All

![Choosing Application permissions, then searching for and ticking TeamworkDevice.Read.All](/hc/article_attachments/54863299150099)
...
![The permission list showing TeamworkDevice.Read.All with the status Not granted](/hc/article_attachments/54863338686867)
...
![The permission list showing Granted for the tenant, with green check marks](/hc/article_attachments/54863338849811)
...
![The client secret row, with the Value column highlighted next to the Secret ID](/hc/article_attachments/54863322414227)
...
![The Add Microsoft Service Principal dialog filled in, showing Connection successful](/hc/article_attachments/54863315258387)
