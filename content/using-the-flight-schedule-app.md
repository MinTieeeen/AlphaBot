...
![Files/Assets sidebar with the Apps button highlighted](/hc/article_attachments/55670035900179)

Search then click **Flight Schedule**.

![App picker filtered to Flight, with the Flight Schedule app card highlighted](/hc/article_attachments/55669145937427)
...
![Flight Schedule settings: Name, Airport and Direction, with Advanced collapsed below](/hc/article_attachments/55669735927059)
...
![Airport picker searched for ORD, with Chicago O'Hare highlighted in the results](/hc/article_attachments/55669981519635)
...
![Advanced settings: Theme, Layout, Time format, Use screen's local time and Page speed](/hc/article_attachments/55669107975059)
...
![Direction selector open on Departures and Arrivals](/hc/article_attachments/55670027141907)

![Arrivals board listing origin, airline, flight, time, terminal and status](/hc/article_attachments/55670049727635)
...
![Flight Schedule dialog footer with the Save button highlighted](/hc/article_attachments/55670027386643)
...
![Live departures board for Chicago O'Hare with real flights, terminals and statuses](/hc/article_attachments/55669115866515)
...
![Screens list with the Edit button on a screen's row highlighted](/hc/article_attachments/55674914699539)

The Edit Screen dialog opens:

![Edit Screen dialog showing Device Name, Content Type, Selected Asset and Orientation](/hc/article_attachments/55674331683731)

Set **Content Type** to **Asset** :

![Edit Screen dialog with the Content Type list open and Asset highlighted](/hc/article_attachments/55674126229523)

Click **Change** , search for your Flight Schedule asset, select it, then click **Select** :

![Select Asset dialog with the Flight Schedule asset chosen and Select highlighted](/hc/article_attachments/55674111008531)

Back on the Edit Screen dialog the asset you picked appears under **Selected Asset**. Click **Save** to commit it:

![Edit Screen dialog with the flight board as Selected Asset and Save enabled](/hc/article_attachments/55674903123987)
