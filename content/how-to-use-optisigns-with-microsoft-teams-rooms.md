...
![teams rooms using digital signage](/hc/article_attachments/36911639363347)
...
![teams rooms pro manager digital signage setting](/hc/article_attachments/36911639368723)

On this screen, ensure the Digital signage switch is **On** (it should be by default), then click **Add Source**.

![teams rooms digital signage screen steps](/hc/article_attachments/36911646828435)

This screen will appear:

![teams rooms add digital signage source](/hc/article_attachments/36911646829075)
...
![custom source ms teams rooms optisigns web player](/hc/article_attachments/37071139357331)

The last screen is a Review screen. If everything looks good, hit Finish.

Last, you'll need to input your pairing code:

![optisigns web player + pairing code](/hc/article_attachments/37071127510291)
...
![teams rooms assign to rooms choice](/hc/article_attachments/36911639371667)

Choose the Source you made in the last step, then hit **Next**.

![teams rooms assign to rooms select source](/hc/article_attachments/36911639373203)

Now you’ll be reviewing your preferences for how to display signage on your Rooms app.

![teams rooms assign to rooms review preferences](/hc/article_attachments/36911646833939)
...
![teams rooms assign rooms](/hc/article_attachments/36911646834451)

Here, simply choose the Room you want the signage to display it. Hit **Next**.

![teams rooms assign rooms select schedule](/hc/article_attachments/36911639374867)
...
![optisigns portal files assets app](/hc/article_attachments/36911646823955)

Search for **Virtual Screen App** , then select it.

![virtual screen app optisigns](/hc/article_attachments/36911646824467)

You’ll see a screen similar to this:

![virtual screen app config optisigns](/hc/article_attachments/36911639366931)

You’ll need to fill in the information on the side. 

![virtual screen app information filled in](/hc/article_attachments/36911646826515)
...
![virtual screen app completely configured](/hc/article_attachments/36911639367955)
...
![teams rooms digital signage select source](/hc/article_attachments/36911646830483)
