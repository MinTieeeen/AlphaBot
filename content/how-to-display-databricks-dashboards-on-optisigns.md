...
![Databricks workspace menu open with Settings highlighted](/hc/article_attachments/54089526933395)

Open **Identity and access** , then find **Service principals** and hit **Manage**.

![Databricks Identity and access settings with Manage beside Service principals](/hc/article_attachments/54089511420947)

Click Add service principal, then Add new service principal to account and workspace:

![Add service principal dialog with Add new service principal to account and workspace selected](/hc/article_attachments/54089526939667)

Keep the default entitlements (**Consumer** , **Databricks SQL** , **Workspace** = On; **Admin** = Off) → **Add service principal:**

![Add service principal dialog with the name and entitlements set and Admin access off](/hc/article_attachments/54089526941331)
...
[![Databricks home page with the browser address bar labelled Workspace URL and Workspace ID](/hc/article_attachments/54089511430547)](https://support.optisigns.com/optisigns/optisigns-smallapp/optisigns-smallapp-databricks/-/raw/feature/danling/databricks/docs/images/03-databricks-workspace-url-id.png)

You can also find the Workspace ID in your workspace menu.

![Databricks workspace menu showing the Workspace ID with its copy button](/hc/article_attachments/54089526942995)
...
![OptiSigns account menu expanded to More with Integrations highlighted](/hc/article_attachments/54089511434643)

Then, click the **Databricks tab** → **Add Databricks Connection**.

![OptiSigns Integrations page on the Databricks tab with the Add Databricks Connection button](/hc/article_attachments/54089511435539)

Fill in the form:

![Add Databricks Connection form with fields for workspace URL, ID, client ID and OAuth secret](/hc/article_attachments/54089526946323)
...
![Databricks Security settings with the Embed dashboards dropdown open on Allow](/hc/article_attachments/54089511438611)
...
![Databricks publish dialog showing Share data permission selected and the Publish button](/hc/article_attachments/54089511440019)
...
![Databricks Catalog Explorer on the signage_demo Permissions tab with Grant highlighted](/hc/article_attachments/54312955352723)
...
[![Grant dialog for the optisigns_embed principal with USE SCHEMA and SELECT ticked](/hc/article_attachments/54312987805715)](https://support.optisigns.com/optisigns/optisigns-smallapp/optisigns-smallapp-databricks/-/raw/feature/danling/databricks/docs/images/10-databricks-grant-sp-privileges.png)
...
![OptiSigns Add App dialog with the Databricks app tile in the search results](/hc/article_attachments/54089511443091)

You'll open up the Databricks app and need to fill in some required information:

![OptiSigns Databricks app settings with connection, published dashboard and refresh interval](/hc/article_attachments/54089526955283)
...
[![OptiSigns Screens list with the Edit button highlighted on a screen](/hc/article_attachments/54089526956179)](/hc/article_attachments/54089526956179)

This brings us to the **Edit Screen** tab:

[![Edit Screen dialog with Content Type set to Asset and an asset selector](/hc/article_attachments/54089511451283)](/hc/article_attachments/54089511451283)
