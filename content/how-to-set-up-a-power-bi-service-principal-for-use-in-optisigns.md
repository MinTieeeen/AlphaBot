...
![app registration instructions in microsoft azure](/hc/article_attachments/32860610406547)

Create a **New Registration**.

![how to create a new registration in microsoft azure](/hc/article_attachments/32860569069459)
...
![instructions on registering an application in microsoft azure](/hc/article_attachments/32860610418707)
...
![finding developer settings in tenant settings within powerbi admin portal](/hc/article_attachments/32860610420627)

Enable the **Embed Content in Apps Settings** , as below:

![how to enable embed content in apps](/hc/article_attachments/32860610421779)
...
![image \(28\)\(1\).png](/hc/article_attachments/42225175622675)
...
![how to grant service principal access powerbi](/hc/article_attachments/32860610425107)

Add the service principal you created in the last step as a member of the workspace.

![how to add service principal as a member of powerbi workspace](/hc/article_attachments/32860569093139)
...
![where to find app registration information in microsoft azure](/hc/article_attachments/32860569095571)
...
**![how to create new client secret in microsoft azure](/hc/article_attachments/32860569099411)**

Next, set the**Description** and **Expiry** , then click **Add**.

![how to add a client secret](/hc/article_attachments/32860569100947)
...
![where to find integrations tab in optisigns](/hc/article_attachments/32860610434451)

A screen like the one below will appear. Click **Add Azure Service Principal.**

![how to add service principal in optisigns](/hc/article_attachments/32860569109011)
...
![inputting all the powerbi service principal information into optisigns](/hc/article_attachments/32860610442771)
...
**![how to find powerbi app in optisigns](/hc/article_attachments/32860569116691)**
...
**![powerbi app information in optisigns](/hc/article_attachments/32860610472339)**
...
**![preview of powerbi app running in optisigns](/hc/article_attachments/32860610476307)**
...
Related to
  ...
  * [ powerbi ](/hc/en-us/search?content_tags=01KKYY3R3HSG9BND306PRY78EP&utf8=%E2%9C%93 "Search results")
  * [ power bi ](/hc/en-us/search?content_tags=01KKYY3W523WHE9PGJRG0259D2&utf8=%E2%9C%93 "Search results")
