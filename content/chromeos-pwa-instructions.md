...
![chrome os setup part one](/hc/article_attachments/49039295530643)

On the bottom left, click the **\+ symbol**. Then, choose **Add by URL**.

![chromeos setup add by url](/hc/article_attachments/49039295533587)

Now copy and paste our OptiSigns PWA URL ([webapp.optisigns.com](https://webapp.optisigns.com)) into the open window. Click **Save**.

![chromeos add by url window](/hc/article_attachments/50218174250259)

The OptiSigns app will appear as a Kiosk app:

![chromeos setup optisigns app in window](/hc/article_attachments/50218174254355)
...
![chromeos app adding extension](/hc/article_attachments/50218184677139)

Click this button and choose **Add from Chrome Web Store:**

![add extension from chrome web store](/hc/article_attachments/50218174257043)
...
![optisigns chrome web store search for id](/hc/article_attachments/50218174262931)

Now, you should see that the OptiSigns Digital Signage app has been added to your extensions

![optisigns as chromeos extension](/hc/article_attachments/50218174266003)
...
![provisioning templates](/hc/article_attachments/50218184695315)

Hit **Create New Provisioning Template:**

![optisigns create provisioning template](/hc/article_attachments/49041868805267)

You'll be asked to set up the template.

![provisioning template creation window](/hc/article_attachments/49039280054419)
...
![adding chromeos to provisioning template](/hc/article_attachments/49039295552531)
...
![](/hc/article_attachments/49039295553299)
...
![optisigns provisioning id](/hc/article_attachments/49039295555347)

Your JSON value will now appear in the field:

![optisigns provisioning json](/hc/article_attachments/49039280067219)
...
Related to
  ...
  * [ chrome ](/hc/en-us/search?content_tags=01K2D44Y8J6CB2AG6ZFSBMN2MP&utf8=%E2%9C%93 "Search results")
  * [ chromeOS ](/hc/en-us/search?content_tags=01KH6YF2VT05V01221VA1NXPXD&utf8=%E2%9C%93 "Search results")
