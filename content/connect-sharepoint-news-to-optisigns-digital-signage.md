...
![The Files/Assets page with the Apps button that opens the app picker](/hc/article_attachments/55453725559571)

Choose **SharePoint News**.

![Apps dialog searched for SharePoint, with the SharePoint News tile highlighted](/hc/article_attachments/55450681489939)
...
![Browser address bar showing a SharePoint site URL ending in /sites/Demo01](/hc/article_attachments/55450681586195)

![SharePoint News config with Name and SharePoint Site URL filled in, beside Test Connection](/hc/article_attachments/55450678578451)
...
![Choose Authentication Method showing Use Service Principal and Direct Login options](/hc/article_attachments/55450681756691)
...
![Direct Login selected, showing the Sign in with Microsoft button](/hc/article_attachments/55451544297619)
...
![The Integrations page, Power BI tab, with the Add Azure Service Principal button](/hc/article_attachments/55453742263699)
...
![Which Azure value goes in which OptiSigns field: client ID, tenant ID, and the secret Value — not the Secret ID](/hc/article_attachments/55452331655955)
...
![The Azure permission-type choice: Delegated permissions versus Application permissions](/hc/article_attachments/55453742174611)
...
![Azure API permissions with Microsoft Graph Sites.Read.All added as an application permission](/hc/article_attachments/55453702633107)
...
![Azure API permissions showing the Status column reading Granted for the organisation](/hc/article_attachments/55450665542419)

Now pick your Service Principal from **Select the Service Principal Integration**.

![The Select the Service Principal Integration field with an integration chosen](/hc/article_attachments/55450695938195)
...
![Success toast reading Connected to Demo01 after Test Connection](/hc/article_attachments/55453698231315)

**Save** , then add the news wall to a playlist or assign it to a screen as you would any other app.

![The configuration dialog footer with the Save button](/hc/article_attachments/55453742353811)
...
![The Appearance section expanded, showing Display Mode, Theme, Font Size and the toggles](/hc/article_attachments/55451529071507)
...
![The Font Size dropdown open, showing the Default and Custom options](/hc/article_attachments/55451691334931)
...
![The Post Settings section showing Number of Posts, Max Age of Posts and Post Duration](/hc/article_attachments/55451529178771)
...
![The Advanced section showing Refresh Interval set to 3600 seconds](/hc/article_attachments/55451552534803)
