...
![how to navigate to datasource](/hc/article_attachments/39080869728915)

From there, hit **Add Request**.

![datasources add request button](/hc/article_attachments/39080900410515)

Create a **GET****Request** and input your API endpoint, then click **Pre-request:**

![optisigns api request form pre-request](/hc/article_attachments/39080869729555)
...
![properly configured API header](/hc/article_attachments/39080900411795)
...
![successful api request](/hc/article_attachments/39080869736211)
