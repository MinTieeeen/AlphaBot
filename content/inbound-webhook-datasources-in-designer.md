...
![DataSources panel in Designer with the Add DataSource button highlighted](/hc/article_attachments/55719323519763)

### Choose Inbound Webhook

Under **Nested, JSON format** , choose the **Inbound Webhook** card ("Push data in from any app or automation that can POST").

![Add DataSource picker with the Inbound Webhook card under Nested, JSON format highlighted](/hc/article_attachments/55747033217427)
...
![Add DataSource form with a name, Event mode, Keep at most and Default expire after, and the Generate Webhook button](/hc/article_attachments/55719323702163)
...
![Generated Webhook URL and Key, blurred, with the URL copy icon highlighted](/hc/article_attachments/55719362187283)
...
![Regenerate key confirmation dialog warning that the current link stops working, with the Regenerate button](/hc/article_attachments/55747023353875)
...
![Detect Payload with sample JSON pasted and the detected fields order, customer and status listed](/hc/article_attachments/55719345210899)
...
![Dialog asking whether to use the dragged field in a Repeater or on its own, with Use in a Repeater highlighted](/hc/article_attachments/55747002517139)
...
![Edit Data grid for a webhook DataSource with a Status column showing one Expired row and one Live row](/hc/article_attachments/55747013126419) When a feed has no live rows left, your screens follow the DataSource's **Empty Data Handling** setting.
...
![Inbound Webhook DataSource card with its menu open and Edit Settings highlighted](/hc/article_attachments/55719345281811)
